...
function WatchedList({ watched, onSelectMovie, onDeleteWatched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovie key={movie.imdbID} movie={movie} onSelectMovie={onSelectMovie} onDeleteWatched={onDeleteWatched} />
      ))}
    </ul>
  )
}
